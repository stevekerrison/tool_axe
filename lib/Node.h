...
public:
  ...
  ChanEndpoint *getIncomingChanendDest(ResourceID ID, tokRate *tokDelay = 0);
  /// Find the destination of a packet sent to the specified resource ID from
  /// this node.
  virtual ChanEndpoint *getOutgoingChanendDest(ResourceID ID, tokRate *tokDelay = 0);
  virtual ChanEndpoint *getLocalChanendDest(ResourceID ID, tokRate *tokDelay = 0) = 0;
